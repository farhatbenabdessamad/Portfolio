    ...
    <section className="resume-section" id="about">
      <div className="resume-section-content" style={{ marginTop: "0px" }}>
        <div id="Myname" style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
          <h1 className="mb-0" style={{ color: "white", fontFamily: "Courier New, monospace" }}> Farhat <span className="text-primary">  Ben Abdessamad</span>
          </h1>
        ...
        <p className="lead mb-5" style={{ textAlign: "justify" }}>
        ...
        <div className="social-icons">
          <a className="social-icon" href="https://www.linkedin.com/in/farhat-ben-abdessamad/">
